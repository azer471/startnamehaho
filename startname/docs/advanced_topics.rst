...
The two methods in our open news example look like this::
	...
	from posts.models import NewsWebsite, Article
...
a lower interval, e.g. 1 minute. Now you should see a new task coming in and being executed every minute::
	...
	Got task from broker: posts.tasks.run_spiders[5a3fed53-c26a-4f8f-b946-8c4a2c7c5c83]
	Task posts.tasks.run_spiders[5a3fed53-c26a-4f8f-b946-8c4a2c7c5c83] succeeded in 0.052549123764s: None
...
`settings.py` file::
	...
	ITEM_PIPELINES = [
	    ...
	    'posts.scraper.pipelines.DjangoWriterPipeline',
	]
